...
<template>
  <div class="wrapper">
    <div
      class="wrapper-bg _webp-true"
      data-aos="fade-in"
      data-aos-delay="200"
      style="background-image: url(img/body-bg.webp)"
    ></div>
    <div
      class="wrapper-bg _webp-false"
      data-aos="fade-in"
      data-aos-delay="200"
          ...
          <div class="header__nav--body">
            <ul class="header__nav--list">
              <li class="header__nav--item">
                <a class="header__nav--link _current"> Главная </a>
              </li>
              <li class="header__nav--item">
                <a href="online-games.html" class="header__nav--link"> Игры </a>
              </li>
              <li class="header__nav--item">
                <a href="rooms.html" class="header__nav--link"> Комнаты </a>
              </li>
              <li class="header__nav--item">
            ...
            <div class="header__nav--user-info header__user-info">
              ...
              <div
                class="header__user-info--notifications header__notifications"
              >
                <button
                  class="header__notifications--toggle-btn"
                  type="button"
                  title="Уведомления"
                >
                  <svg
                ...
                <div class="header__notifications--block">
                  <div class="header__notifications--body custom-scrollbar">
                    <ul class="header__notifications--list">
                      <li class="header__notifications--item notification-item">
                        <div class="notification-item__body">
                          <div class="notification-item__header">
                            ...
                            <span class="notification-item__time"> </span>
                          </div>
                          <div class="notification-item__content">
                            <p>
                              У вас незавершенная игра, вернитесь чтобы
                              закончить
                            </p>
                            <a href="#" class="notification-item__link">
                              Вернуться
                              <svg
                                width="5"
                                height="7"
                        ...
                        <div class="notification-item__body">
                          <div class="notification-item__header _message">
                            <img
                              ...
                              class="notification-item__icon"
                            />
                            <h3 class="notification-item__title" title="Бонус!">
                              Бонус!
                            </h3>
                          ...
                          <div class="notification-item__content">
                            <p>От сервиса начислено 20 фишек</p>
                          </div>
                        </div>
                      </li>
                      <li class="header__notifications--item notification-item">
            ...
            <div
              class="header__nav--language header__language header__drop-down"
            >
              <button
                type="button"
                class="header__language--target header__drop-down--target"
              >
                Ru
                <svg
                  width="7"
              ...
              <div class="header__drop-down--block">
                <div class="header__drop-down--body">
                  <ul class="header__drop-down--list">
                    <li class="header__drop-down--item">
                      <a href="#" class="header__drop-down--link"> RU </a>
                    </li>
                    <li class="header__drop-down--item">
                      <a href="#" class="header__drop-down--link"> EN </a>
                    </li>
                    <li class="header__drop-down--item">
                      <a href="#" class="header__drop-down--link"> ES </a>
                    </li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="header__nav--account header__account header__drop-down">
              <button
                type="button"
              ...
              >
                ...
                <span class="header__account--name"> Jane_006 </span>
                <svg
                  width="7"
                  height="5"
                  viewBox="0 0 7 5"
              ...
              <div class="header__drop-down--block">
                <div class="header__drop-down--body">
                  <ul class="header__drop-down--list">
                    <li class="header__drop-down--item">
                      <a href="#" class="header__drop-down--link"> Профиль </a>
                    </li>
                    <li class="header__drop-down--item">
                      <a href="#" class="header__drop-down--link">
                        Настройки
                      </a>
                    </li>
                    <li class="header__drop-down--item _line">
                      <a href="#" class="header__drop-down--link"> Выйти </a>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div class="header__nav-mob--bg">
            <picture>
              ...
              <img
                ...
                width="0"
                height="0"
                class="header__nav-mob--bg-img"
              />
            </picture>
          </div>
          <div class="header__nav-mob--body">
            <ul class="header__nav-mob--list">
              <li class="header__nav-mob--item">
                <div
                  class="header__nav-mob--account header__mob-account header__mob-select custom-select _active"
                >
                  <button
                    type="button"
                    title="Профиль"
                    class="header__mob-account--target header__mob-select--target custom-select__target"
                  >
                    <picture>
                      <source
                      ...
                      <img
                        ...
                        alt=""
                        loading="lazy"
                        class="header__mob-account--avatar"
                      />
                    </picture>
                    <span class="header__mob-account--name"> Jane_006 </span>
                    <svg
                      width="7"
                      height="5"
                      viewBox="0 0 7 5"
                  ...
                  <div class="header__mob-select--block custom-select__block">
                    <ul class="header__mob-select--list">
                      <li class="header__mob-select--item">
                        <a href="#" class="header__mob-select--link">
                          <svg
                            width="9"
                            height="10"
                            viewBox="0 0 9 10"
                          ...
                          >
                            <path
                              d="M4.5 5C5.92031 5 7.07143 3.88066 7.07143 2.5C7.07143 1.11934 5.92031 0 4.5 0C3.07969 0 1.92857 1.11934 1.92857 2.5C1.92857 3.88066 3.07969 5 4.5 5ZM5.51853 5.9375H3.48147C1.55913 5.9375 0 7.45312 0 9.32227C0 9.69609 0.311786 9.99941 0.696295 9.99941H8.30411C8.68862 10 9 9.69727 9 9.32227C9 7.45312 7.44107 5.9375 5.51853 5.9375Z"
                              fill="#F9F1DF"
                            />
                          </svg>
                          Личный кабинет
                      ...
                      <li class="header__mob-select--item">
                        <a
                          href="#promocode-popup"
                          class="header__mob-select--link _accent open-popup"
                        >
                          <svg
                            width="14"
                            height="14"
              ...
              <li class="header__nav-mob--item">
                <a href="#" class="header__nav-mob--link"> Главная </a>
              </li>
              <li class="header__nav-mob--item">
                <a href="online-games.html" class="header__nav-mob--link">
                  Игры
                </a>
              </li>
              <li class="header__nav-mob--item">
                <a href="#" class="header__nav-mob--link"> Комнаты </a>
              </li>
              <li class="header__nav-mob--item">
                <a href="#" class="header__nav-mob--link"> Новости </a>
              </li>
              <li class="header__nav-mob--item">
                <a href="#" class="header__nav-mob--link"> Преимущества </a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <main class="main">
      <section class="chess page-padding-top">
        <div class="chess__container container _large-2">
          <div class="game__header">
            <div class="game__header--col">
              <h2 class="game__header--name section-title _decor-none">
                Шахматы
              </h2>
            </div>
            <div class="game__header--col">
              <div class="game__header--block">
                <a
                  href="#game-exit-popup"
                  class="game__header--btn btn _dark open-popup"
                >
                  Выйти
                </a>
                <a
                  href="#game-invite-popup"
                  class="game__header--btn btn _red open-popup"
                >
                  Пригласить +
                </a>
              </div>
          ...
          <div class="chess__main">
            <div class="chess__main--row chess__row">
              <div class="chess__col">
                <div class="chess__col--item"></div>
                <div class="chess__col--item">
                  <div class="chess__communication game__communication">
                    <button
                      class="game__communication--btn micro-btn game-btn"
                      type="button"
                      title="Выключить микрофон"
                      data-title-off="Выключить микрофон"
                    ...
                    <button
                      class="game__communication--btn chat-btn game-btn"
                      title="Чат игры"
                      type="button"
                    >
                      <svg
                    ...
                    <div
                      class="game__communication--chat game__chat"
                      style="display: none"
                    >
                      <div class="game__chat--body">
                        <div class="game__chat--header">
                          <button
                            class="game__chat--close-btn"
                            type="button"
                            title="Закрыть чат"
                          >
                            <svg
                        ...
                        <ul class="game__chat--list">
                          <li class="game__chat--item">
                            ...
                            <div class="game__chat--info">
                              <h3 class="game__chat--name">Jane456</h3>
                              <div class="game__chat--text">
                                Aliqua id fugiat nostrud irure ex duisAliqua id
                                fugiat nostrud irure ex
                              </div>
                            </div>
                          </li>
                          <li class="game__chat--item">
                        ...
                        <form action="#" class="game__chat--message">
                          <label class="game__chat--message-label">
                            <input
                              type="text"
                              name="chat-message"
                              required
                              placeholder="Введите сообщение..."
                              class="game__chat--message-input"
                            />
                          </label>
                          <button
                            class="game__chat--message-submit"
                            type="submit"
              ...
              <div class="chess__col chess__game">
                <div class="chess__player">
                    ...
                    <div class="game__player--body">
                      <div class="game__player--avatar">
                        <img
                          ...
                          height="76"
                          alt=""
                          class="game__player--avatar-img"
                        />
                      </div>
                      <div class="game__player--info">
                        <h3 class="game__player--name">Игорь</h3>
                        <progress
                          class="game__player--progress"
                          max="100"
                          value="100"
                        ></progress>
                      </div>
                      <div class="game__player--block">
                        <div class="game__player--status">
                          Готов
                          <svg
                            width="12"
                            height="12"
                ...
                <div class="chess__user">
                  <div class="game__user">
                    <div class="game__user--block"></div>
                    <div class="game__user--info">
                      <div class="game__user--info-body">
                        <h3 class="game__user--name">Вы: Евгений</h3>
                        <progress
                          class="game__user--progress"
                          max="100"
                          value="100"
                        ></progress>
                      </div>
              ...
              <div class="chess__col">
                <div class="chess__history game__history">
                  <div class="game__history--wrapper">
                    <button type="button" class="game__history--header">
                      <h3 class="game__history--header-title">История ходов</h3>
                      <div class="game__history--header-arrow">
                        <svg
                          width="13"
                          height="8"
                          viewBox="0 0 13 8"
                    ...
                    <ul class="chess__history--list game__history--list">
                      <li class="chess__history--item game__history--item">
                        <span class="chess__history--move"> Pe4 </span>
                        <span class="chess__history--move"> Nc6 </span>
                      </li>
                      <li class="chess__history--item game__history--item">
                        <span class="chess__history--move"> Pe4 </span>
                        <span class="chess__history--move"> Nc6 </span>
                ...
                <div class="chess__ready">
                  <h3 class="game__user-menu--title section-title _decor-none">
                    Вы готовы?
                  </h3>
                  <div class="game__user-menu--timer">
                    Осталось:
                    <b>10 сек</b>
                  </div>
                  <button
                    class="game__user-menu--main-btn btn _large _shadow"
                    type="button"
                  >
                    Я готов
                  </button>
    ...
    <footer class="footer" data-aos="fade-in" data-aos-anchor=".main">
      <div class="footer__container container _large">
        <div class="footer__intro">
          ...
          <div class="footer__contacts">
            <a
              href="tel:+38098111111"
              class="footer__contacts--link"
              aria-label="+38098111111"
            >
              <svg
                width="17"
                height="16"
              ...
              >
                <path
                  d="M0.599373 10.6435L4.03698 9.36192C4.44189 9.20955 4.91682 9.3123 5.19183 9.60931L6.58873 11.092C8.78279 10.1553 10.565 8.60405 11.6422 6.69795L9.93731 5.4847C9.59672 5.24279 9.48076 4.83207 9.65299 4.47999L11.1266 1.49094C11.3196 1.10774 11.7951 0.898094 12.2605 0.992036L15.4542 1.63255C15.9056 1.72208 16.2215 2.06782 16.2215 2.47168C16.2215 9.42225 9.72016 15.0753 1.72653 15.0753C1.26174 15.0753 0.865384 14.8007 0.76178 14.408L0.0251496 11.6311C-0.0815272 11.2275 0.158915 10.8088 0.599373 10.6435Z"
                  fill="#F9F1DF"
                />
              </svg>
              <span> +38098111111 </span>
            </a>
            <a
              href="mailto:boardgames@gmail.com"
              class="footer__contacts--link"
            ...
            >
              ...
              <span> boardgames@gmail.com </span>
            </a>
          </div>
          <div class="footer__social">
            <ul class="footer__social--list">
              ...
              <li class="footer__social--item">
                <a href="#" class="footer__social--link" title="Telegram">
                  <svg
                    width="24"
                    height="23"
                    viewBox="0 0 24 23"
          ...
          <div class="footer__nav--row">
            <div class="footer__nav--col">
              <ul class="footer__nav--list">
                <li class="footer__nav--item">
                  <a href="#" class="footer__nav--link"> Игры </a>
                </li>
                <li class="footer__nav--item">
                  <a href="#" class="footer__nav--link"> Главная </a>
                </li>
                <li class="footer__nav--item">
                  <a href="#" class="footer__nav--link"> Комнаты </a>
                </li>
                <li class="footer__nav--item">
            ...
            <div class="footer__nav--col">
              <ul class="footer__nav--list">
                ...
                <li class="footer__nav--item">
                  <a href="#" class="footer__nav--link"> Документ </a>
                </li>
                <li class="footer__nav--item">
                  <a href="#" class="footer__nav--link"> Статья о сервисе </a>
                </li>
                <li class="footer__nav--item">
                  <a href="#" class="footer__nav--link"> Статья </a>
                </li>
              </ul>
            </div>
          </div>
        </nav>
        <div class="footer__hot">
          <h2 class="footer__hot--title">Горячие предложения!</h2>
          <ul class="footer__hot--list">
            <li class="footer__hot--item">
              <a
                href="page-game.html"
                class="footer__hot--link"
                title="Название игры"
              >
                <picture>
                  <source
    ...
    <div
      class="registration-popup popup"
      id="registration-popup"
      style="display: none"
    >
      <div class="registration-popup__wrapper popup-wrapper">
        <div class="registration-popup__bg popup-bg popup-close"></div>
        <div class="registration-popup__body popup-body">
          <div class="registration-popup__decor popup-decor">
            <div
              class="popup-decor__element _levitation"
            ...
            >
              <picture>
                ...
                <img
                  ...
                  width="0"
                  height="0"
                  class="popup-decor__element--img"
                />
              </picture>
            </div>
            <div
          ...
          <div class="registration-popup__container popup-container">
            <button
              type="button"
              class="registration-popup__close-btn popup-close-btn popup-close"
              title="Закрыть"
            >
              <svg
                viewBox="0 0 19 17"
            ...
            <div class="registration-popup__logo popup-logo">
              <img
                ...
                height="38"
                alt=""
                class="popup-logo__img"
              />
            </div>
            <h2
              class="registration-popup__title popup-title section-title _center"
            >
              Регистрация
            </h2>
            <form action="#" class="registration-popup__form popup-form">
              <div class="registration-popup__form--list popup-form-list">
                <label class="registration-popup__label popup-label">
                  <input
                    type="email"
                    name="email"
                    required
                    placeholder="Email"
                    class="registration-popup__input popup-input email-valid-input"
                  />
                  <span
                    class="registration-popup__input-placeholder popup-input-placeholder"
                    >Email</span
                  >
                </label>
                <label class="registration-popup__label popup-label">
                  <input
                    ...
                    class="registration-popup__input popup-input"
                  />
                  <span
                    class="registration-popup__input-placeholder popup-input-placeholder"
              ...
              <div class="registration-popup__checkbox popup-checkbox">
                <label class="popup-checkbox__label">
                  <input
                    type="checkbox"
                    name="service-usage-rules"
                    required
                    class="popup-checkbox__input"
                  />
                  <span class="popup-checkbox__element"></span>
                  <span class="popup-checkbox__text">
                    Я соглашаюсь со всеми
                    <a href="index.html">правилами использования сервиса</a>
                  </span>
                </label>
              </div>
              <button
                type="submit"
                class="registration-popup__submit popup-submit btn _large _shadow"
              >
                Зарегистрироваться
              </button>
              <a
                href="#login-popup"
                class="registration-popup__link popup-link popup-close open-popup"
              >
                У меня уже есть аккаунт
              </a>
              <div class="registration-popup__via popup-via">
                <div class="popup-via__body">
                  <h3 class="popup-via__title">Зарегестрироваться через</h3>
                  <ul class="popup-via__list">
                    <li class="popup-via__item">
                      <a href="#" class="popup-via__btn" title="Facebook">
                        <svg
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
                    ...
                    <li class="popup-via__item">
                      <a href="#" class="popup-via__btn" title="Google">
                        <svg
                          width="20"
                          height="20"
                          version="1.1"
                        ...
                        >
                          <path
                            d="M19.8,10.2c0-0.7-0.1-1.4-0.2-2h-9.4V12h5.4c-0.2,1.2-0.9,2.3-2,3v0c-0.9,0.6-2.1,1-3.4,1
                    ...
                    <li class="popup-via__item">
                      <a href="#" class="popup-via__btn" title="Apple">
                        <svg
                          width="16"
                          height="18"
                          viewBox="0 0 16 18"
    ...
    <div class="login-popup popup" id="login-popup" style="display: none">
      <div class="login-popup__wrapper popup-wrapper">
        <div class="login-popup__bg popup-bg popup-close"></div>
        <div class="login-popup__body popup-body">
          <div class="login-popup__decor popup-decor">
            <div
              class="popup-decor__element _levitation"
              style="animation-duration: 9s"
            >
          ...
          <div class="login-popup__container popup-container">
            <button
              type="button"
              class="login-popup__close-btn popup-close-btn popup-close"
              title="Закрыть"
            >
              <svg
                viewBox="0 0 19 17"
            ...
            <h2 class="login-popup__title popup-title section-title _center">
              Вход
            </h2>
            <form action="#" class="login-popup__form popup-form">
              <div class="login-popup__form--list popup-form-list">
                <label class="login-popup__label popup-label">
                  <input
                    type="email"
                    name="email"
                    required
                    placeholder="Email"
                    class="login-popup__input popup-input email-valid-input"
                  />
                  <span
                    class="login-popup__input-placeholder popup-input-placeholder"
                    >Email</span
                  >
                </label>
                <label class="login-popup__label popup-label">
                  <input
                    ...
                    required
                    placeholder="Пароль"
                    class="login-popup__input popup-input"
                  />
                  <span
                    class="login-popup__input-placeholder popup-input-placeholder"
                    >Пароль</span
              ...
              <button
                type="submit"
                class="login-popup__submit popup-submit btn _large _shadow"
              >
                Войти
              </button>
              <a
                href="#registration-popup"
                class="login-popup__link popup-link popup-close open-popup"
              >
                Зарегестрироваться
              </a>
              <a
              ...
              <div class="login-popup__via popup-via">
                <div class="popup-via__body">
                  <h3 class="popup-via__title">Войти через</h3>
                  <ul class="popup-via__list">
                    <li class="popup-via__item">
                      <a href="#" class="popup-via__btn" title="Facebook">
                        <svg
    ...
    <div
      class="forgot-password-popup popup"
      id="forgot-password-popup"
      style="display: none"
    >
      <div class="forgot-password-popup__wrapper popup-wrapper">
        <div class="forgot-password-popup__bg popup-bg popup-close"></div>
        <div class="forgot-password-popup__body popup-body">
          <div class="forgot-password-popup__container popup-container">
            <button
              type="button"
              class="forgot-password-popup__close-btn popup-close-btn popup-close"
              title="Закрыть"
            >
              <svg
                viewBox="0 0 19 17"
            ...
            <h2
              class="forgot-password-popup__title popup-title section-title _center"
            >
              Забыли пароль?
            </h2>
            <div class="forgot-password-popup__text popup-text">
              Введите ваш email и пароль будет отправлен вам на почту
            </div>
            <form action="#" class="forgot-password-popup__form popup-form">
              <div class="forgot-password-popup__form--list popup-form-list">
                <label class="forgot-password-popup__label popup-label">
                  <input
                    type="email"
                    name="email"
                    required
                    placeholder="Email"
                    class="forgot-password-popup__input popup-input email-valid-input"
                  />
                  <span
                    class="forgot-password-popup__input-placeholder popup-input-placeholder"
                    >Email</span
                  >
                </label>
              </div>
              <button
                type="submit"
                class="forgot-password-popup__submit popup-submit btn _large _shadow _disabled"
              >
                Войти
              </button>
              <a
                href="#login-popup"
                class="forgot-password-popup__link popup-link popup-close open-popup"
              >
                Назад
              </a>
            </form>
    ...
    <div
      class="password-send-popup popup"
      id="password-send-popup"
      style="display: none"
    >
      <div class="password-send-popup__wrapper popup-wrapper">
        <div class="password-send-popup__bg popup-bg popup-close"></div>
        <div class="password-send-popup__body popup-body">
          <div class="password-send-popup__container popup-container">
            <button
              type="button"
              class="password-send-popup__close-btn popup-close-btn popup-close"
              title="Закрыть"
            >
              <svg
                viewBox="0 0 19 17"
            ...
            <h2
              class="password-send-popup__title popup-title section-title _center"
            >
              Забыли пароль?
            </h2>
            <div class="password-send-popup__text popup-text">
              Ваш пароль будет выслан в течении пары минут вам на почту
            </div>
            <a
              href="#login-popup"
              class="password-send-popup__btn btn _large _shadow popup-btn popup-close open-popup"
            >
              Войти в аккаунт
            </a>
          </div>
    ...
    <div
      class="subscribe-popup popup"
      id="subscribe-popup"
      style="display: none"
    >
      <div class="subscribe-popup__wrapper popup-wrapper">
        <div class="subscribe-popup__bg popup-bg popup-close"></div>
        <div class="subscribe-popup__body popup-body">
          <div class="subscribe-popup__container popup-container">
            <button
              type="button"
              class="subscribe-popup__close-btn popup-close-btn popup-close"
              title="Закрыть"
            >
              <svg
                viewBox="0 0 19 17"
            ...
            <h2
              class="subscribe-popup__title popup-title section-title _center"
            >
              Подпишитесь!
            </h2>
            <div class="subscribe-popup__text popup-text">
              Получайте все новости нашего сервиса первыми! И удача всегда будет
              с вами!
            </div>
            <form action="#" class="subscribe-popup__form popup-form">
              <div class="subscribe-popup__form--list popup-form-list">
                <label class="subscribe-popup__label popup-label">
                  <input
                    type="email"
                    name="email"
                    required
                    placeholder="Email"
                    class="subscribe-popup__input popup-input email-valid-input"
                  />
                  <span
                    class="subscribe-popup__input-placeholder popup-input-placeholder"
                    >Email</span
                  >
                </label>
              </div>
              <button
                type="submit"
                class="subscribe-popup__submit popup-submit btn _large _shadow _disabled"
              >
                Подписаться
              </button>
              <a class="subscribe-popup__link popup-link popup-close">
                Назад
              </a>
            </form>
          </div>
    ...
    <div
      class="promocode-popup popup"
      id="promocode-popup"
      style="display: none"
    >
      <div class="promocode-popup__wrapper popup-wrapper">
        <div class="promocode-popup__bg popup-bg popup-close"></div>
        <div class="promocode-popup__body popup-body">
          <div class="promocode-popup__container popup-container">
            <button
              type="button"
              class="promocode-popup__close-btn popup-close-btn popup-close"
              title="Закрыть"
            >
              <svg
                viewBox="0 0 19 17"
            ...
            <h2
              class="promocode-popup__title popup-title section-title _center"
            >
              Промокод
            </h2>
            <form action="#" class="promocode-popup__form popup-form">
              <div class="promocode-popup__form--list popup-form-list">
                <label class="promocode-popup__label popup-label">
                  <input
                    type="text"
                    name="promocode"
                    required
                    placeholder="Промокод"
                    class="promocode-popup__input popup-input"
                  />
                  <span
                    class="promocode-popup__input-placeholder popup-input-placeholder"
                    >Промокод</span
                  >
                </label>
              </div>
              <button
                type="submit"
                class="promocode-popup__submit popup-submit btn _large _shadow"
              >
                Применить
              </button>
            </form>
    ...
    <div
      class="game-exit-popup popup"
      id="game-exit-popup"
      style="display: none"
    >
      <div class="game-exit-popup__wrapper popup-wrapper">
        <div class="game-exit-popup__bg popup-bg popup-close"></div>
        <div class="game-exit-popup__body popup-body">
          <div class="game-exit-popup__container popup-container">
            <button
              type="button"
              class="promocode-popup__close-btn popup-close-btn popup-close"
              title="Закрыть"
            ...
            <h2
              class="game-exit-popup__title popup-title section-title _decor-none"
            >
              Выход из игры
            </h2>
            <div class="game-exit-popup__text popup-text _left">
              Если вы выйдете из игры то вам автоматически будет засчитан
              проигрышь и снята сумма ставки команты
            </div>
            <a href="#" class="game-exit-popup__btn btn popup-btn _red">
              Выйти из игры
            </a>
          </div>
        </div>
    ...
    <div
      class="game-invite-popup popup"
      id="game-invite-popup"
      style="display: none"
    >
      <div class="game-exit-popup__wrapper popup-wrapper">
        <div class="game-exit-popup__bg popup-bg popup-close"></div>
        <div class="game-exit-popup__body popup-body">
          <div class="game-exit-popup__container popup-container">
            ...
            <form action="#" class="game-invite-popup__form popup-form">
              <div class="game-invite-popup__form--list popup-form-list">
                <label class="game-invite-popup__label popup-label">
                  <input
                    type="email"
                    name="email"
                    required
                    placeholder="Email"
                    class="game-invite-popup__input popup-input email-valid-input"
                  />
                  <span
                    class="game-invite-popup__input-placeholder popup-input-placeholder"
                    >Email</span
                  >
                </label>
              </div>
              <button
                type="submit"
                class="game-invite-popup__submit popup-submit btn _large _shadow _disabled"
              >
                Отправить
              </button>
            </form>
